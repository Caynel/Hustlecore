    ...
    if (!empty($activityIdToDelete)) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                // You can redirect or reload if needed
            } else {
...
$sqlSelectActivities = "
    ...
    FROM Activities a
    LEFT JOIN ActivityBookings ab ON a.activityID = ab.activityID AND ab.bookingStatus = 'booked'
...
<body>
    ...
    <main>
        ...
        <!-- Content Area -->
        <div class="content">
            <div class="breadcrumb">&gt; Manage Classes & Sessions</div>
