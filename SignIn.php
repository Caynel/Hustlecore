<?php
    ...
    if(isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true) {
         header("index.php"); //ADD ADMIN PAGE HERE
        exit();
    }
    ...
    $admin_email = "admin@hustle.core"; //ADMIN EMAIL 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($email == $admin_email && $password === $admin_password) {
            ...
            setcookie("email", $admin_email, time() + (3600 * 1000), "/");

            header("Location: index.php"); //ADD ADMIN PAGE HERE
            exit();
        }else {
            $logErr = "Invalid email or password. Please try again. Hint: 12345";
        }
    }
?>
